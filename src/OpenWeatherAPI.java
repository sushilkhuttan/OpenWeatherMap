...
public class OpenWeatherAPI {
	...
	RequestSpecification request = new RequestSpecBuilder().setBaseUri("http://api.openweathermap.org")
			.addQueryParam("appid", "8f77bcfb6e181d97c6380d1ea53d9ff1").build();
	...
	public void getLongLat(String cityName){
		...
		Assert.assertEquals(cityName, cityNameResponse); //Verify the city name is correct
	...
	public Object[] data() {
		return new Object[] {"London","Chicago"};
